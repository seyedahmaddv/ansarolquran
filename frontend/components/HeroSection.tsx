            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl leading-loose">
                        مرکز آموزش و تفسیر قرآن کریم
                        </h1>
                ...
                <div
                    aria-hidden="true"
                    className="absolute inset-x-0 top-[calc(100%-13rejgoijbjgkjbjm)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
                >
                    <div
                        style={{
                            clipPath:
